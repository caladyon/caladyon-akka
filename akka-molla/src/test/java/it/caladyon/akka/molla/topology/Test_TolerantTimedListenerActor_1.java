 ...
 * @deprecated Sostituito da Test_StrategistListenerActor_with_TolerantTimedListening_1.
 */
@Deprecated
@ContextConfiguration(classes = Test_TolerantTimedListenerActor_1.class)
@Configuration
@Import(AkkaConf.class)
public class Test_TolerantTimedListenerActor_1 extends AbstractJUnit4AkkaSpringTests {
	...
	public void test_2() {
		...
		try {
			...
			assertTrue("execution count", actor.getExecCount() == 0);
			assertTrue("input size: " + actor.inputsSize(), actor.inputsSize() == 2);
		} finally {
			ref.stop();
		}
	}
