...
/**
 * <p>
 * Questo JUnit esegue gli stessi test di {@link Test_TimedListenerActor},
 * usando un'istanza di {@link TolerantTimedListenerActor} con tolleranza zero.
 * <p>
 * Si veda il manuale di Akka, capitolo 3.9.1 / Testing the Actor's Behavior.
 *
 * @author Luciano Boschi
 * @deprecated Sostituito con Test_StrategistListenerActor_with_TolerantTimedListening_0
 */
@Deprecated
@ContextConfiguration(classes = Test_TolerantTimedListenerActor_0.class)
@Configuration
@Import(AkkaConf.class)
public class Test_TolerantTimedListenerActor_0 extends AbstractJUnit4AkkaSpringTests {

	/** [millisecondi] */
	private static final int WAIT = 200;

	/** Aumentare in caso di debug! [millisecondi] */
	private static final int TIMEOUT = WAIT;// * 1000;
	 ...
	 *
	 */
	public static class TestTimedListenerActor extends TolerantTimedListenerActor {
	...
	public static final String LISTENER_BEAN_NAME = "tt-listener-actor";
